...
(def lib 'com.sturdystats/sturdy-fs)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "File-system utilities for Clojure (sturdy-fs)."]
     [:url "https://github.com/Sturdy-Statistics/sturdy-fs"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/sturdy-fs"]
      [:connection "scm:git:https://github.com/sturdystats/sturdy-fs.git"]]]})
